...
export const AuthModals: React.FC<AuthModalsProps> = ({
  ...
  const handleSocialLogin = async (provider: 'google' | 'facebook') => {
    ...
    if (provider === 'google') {
      const promptEmail = window.prompt("Google Account Login / गूगल से लॉग इन करें:\nEnter your Google Email Address (e.g. student@gmail.com):", regEmail || "student@gmail.com");
